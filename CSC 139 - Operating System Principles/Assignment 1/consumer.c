...
int main()
{
	const char *name = "OS_HW1_StevenLum"; // Name of shared memory block to be passed to shm_open
...
// Write the implementation
	int val;
	void* ptr = gShmPtr + indx*sizeof(int) + 4*sizeof(int);
	memcpy(&val, ptr, sizeof(int));
	return val;
}
