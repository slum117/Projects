...
int main(int argc, char* argv[])
{
	...
	if(itemCnt > 800)
	{
		printf("Item Count can not exceed 800.\n");
		return 0;
	} else if (itemCnt < 2) {
		printf("Item Count must exceed 1.\n");
		return 0;
	}
...
void InitShm(int bufSize, int itemCnt)
{
    int in = 0;
    int out = 0;
	const char *name = "OS_HW1_StevenLum"; // Name of shared memory object to be passed to shm_open
